...
- (void)createMenuItems:(NSArray *)aItemsArray
{
    ...
    {
        TagsIndex *tagsIndex = aItemsArray[i] ;
        NSString  *vTitleStr = tagsIndex.tag_name ;
        ...
        [vButton setTitleColor:COLOR_PINK_HALF  forState:UIControlStateNormal];
        [vButton setTitleColor:COLOR_PINK       forState:UIControlStateSelected];
